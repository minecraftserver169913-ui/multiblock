...
public class ModBlocks {
    ...
    //skull register
    public static final DeferredBlock<SkullBlock> ICEBOUND_SKULL = registerBlock("icebound_skull",
            () -> new SkullBlock(ModSkullTypes.ICEBOUND, BlockBehaviour.Properties.of().strength(1f).noOcclusion()));
